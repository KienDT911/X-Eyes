...
6. Sử dụng format comment ở đầu của mỗi hàm, method hay class
7. Các comment sẽ được sắp xếp thẳng hàng trên cùng 1 cột phía sau mỗi line code
...
2. Thêm comment giải thích cho các dòng code phức tạp
3. Thêm comment mô tả logic và mục đích của từng phần
4. Sử dụng format comment ở đầu của mỗi hàm, method hay class
    ***********************************************************************
    **** Method: (name)
    **** Description: (business meaning)
    ***********************************************************************
5. Comment phải rõ ràng, dễ hiểu và hữu ích
6. Nếu có comment // cho từng dòng của các hàng, thì phải được sắp xếp thẳng hàng với nhau trên cùng 1 cột 50 phía sau cùng của mỗi line code
